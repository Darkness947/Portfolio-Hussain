...
const Bot = () => {
    ...
    const steps = [
        ...
        {
            id: "skills",
            message: "Hussain's tech skills include HTML, CSS, Java, JavaScript, React, C#, and Unity3D. Worked on Web Development, Game Development, and Desktop App Development 🚀",
            trigger: "askMore",
        },
        {
            id: "projects",
